...
module.exports.findReleases = async ({ app, context, ignorePrereleases }) => {
  ...
  const sortedPublishedReleases = sortReleases(releases.filter((r) => !r.draft && (ignorePrereleasesFilter ? !r.prerelease : true)))
